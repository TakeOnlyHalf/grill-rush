...
export const ActionTypes = {
  ...
  COLLECT_COOKED_INGREDIENT: 'COLLECT_COOKED_INGREDIENT',
  DISCARD_PREPARED_INGREDIENT: 'DISCARD_PREPARED_INGREDIENT',
...
export const MULTI_ORDER_PATIENCE_BONUS_SEC = 3
