...
export { createCustomerSprite } from './sprites/customerSprite'
export { loadCharacterPortraits, CHARACTER_KEYS } from './sprites/characterPortraits'
export { CUSTOMER_CHARACTERS, pickRandomGuestCharacter } from './sprites/customerRegistry'
...
export { createGrillBoardScene } from './scenes/GrillBoardScene'
